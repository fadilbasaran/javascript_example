let kitap1 = { isim: "Her Şeyi Düşünme", yazar: "ali", fiyat: 14, raf: "1.1.RAF" };
let kitap2 = { isim: "Hiç Bir Karşılaşma Tesadüf Değildir", yazar: "", fiyat: 15, raf: "5.1.RAF" };
let kitap3 = { isim: "İnsan Neyle Yaşar", yazar: "veli", fiyat: 20, raf: "3.4.RAF" };
let kitap4 = { isim: "Zafer Sızlanarak Kazanılmaz", yazar: "mehmet", fiyat: 40, raf: "2.5.RAF" };
let kitap5 = { isim: "Şeker Portakalı", yazar: "yaşar", fiyat: 30, raf: "2.2.RAF" };
...
rafOlustur();
let kitapIsmi = prompt("Aradığınız kitabın ismini giriniz: ");
let rafKod = kitapBul(kitapIsmi);
...
if (rafKod!=null) {
    ...
    alert("Aradığınız Kitap kütüphanemizde bulumamaktadır.")
}

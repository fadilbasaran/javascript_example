...
//     console.log(l);//l is not defined tanımlanmadı hatası verir.Çünkü block scope
// }

// selamVer();

// var a=0;//var da aynı değişkende birden fazla defa tanımlanabilir
// var a=23;
// console.log(a);
...
// console.log(users)
//const yapıldığı için değişken içeriğinin değiştirilmesine izin verilmez.
//let olarak tanımlama yapılsaydı, içeriğinin değiştirilmesine olanak sağlanırdı.
